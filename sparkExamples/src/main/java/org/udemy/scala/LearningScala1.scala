...
object LearningScala1 {
  ...
  //Main usage of having single & is it evaluates both the expressions 
  ...
  val pi1 : Double = 3.14159265
  val piDouble = pi1*pi1
  println(f"The double value of pi with three decimal precision $piDouble%.3f")
  }
